...
import com.tencent.qcloud.tim.demo.community.CommunityFragment;
...
import com.tencent.qcloud.tim.demo.map.mapFragment;
...
public class MainActivity extends BaseActivity implements ConversationManagerKit.MessageUnreadWatcher {
    ...
    private void initView() {
        ...
        mCommunityBtn = findViewById(R.id.community);
    ...
    public void tabClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.myself_btn_group:
                ...
                break;
            case R.id.contact_btn_community:
                current = new CommunityFragment();
                mCommunityBtn.setTextColor(getResources().getColor(R.color.tab_text_selected_color));
                mCommunityBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable(R.drawable.community_selected), null, null);
                break;
            case R.id.contact_btn_map:
                current = new mapFragment();
                mMapBtn.setTextColor(getResources().getColor(R.color.tab_text_selected_color));
                mMapBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable(R.drawable.map_selected), null, null);
                break;
            default:
                break;
        }
    ...
    private void resetMenuState() {
        ...
        mCommunityBtn.setTextColor(getResources().getColor(R.color.tab_text_normal_color));
        mCommunityBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable(R.drawable.community_normal), null, null);
        mMapBtn.setTextColor(getResources().getColor(R.color.tab_text_normal_color));
        mMapBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable(R.drawable.map_normal), null, null);
    }
